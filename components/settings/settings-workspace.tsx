...
import { ArrowRight, Code1, Lock, ShieldTick, Wallet } from "@/components/icons";
...
export function SettingsWorkspace() {
  ...
  return <main className="cv-shell mx-auto w-full max-w-[920px] px-4 py-8 sm:py-12">
    ...
    <div className="mt-7 grid gap-4 lg:grid-cols-2">
      ...
      <section className="border border-black/10 bg-white p-5 lg:col-span-2" aria-labelledby="settings-mandates"><div className="flex items-center gap-3"><Lock size={20} /><h2 id="settings-mandates" className="text-xl font-semibold">Mandates</h2></div><p className="mt-3 max-w-xl text-[11px] leading-4 text-neutral-500">Pre-authorized recurring spending with a per-collection maximum, a lifetime cap, a minimum interval, and an expiry. You keep revoke and refund control.</p><Link href="/mandates" className="mt-4 flex min-h-12 items-center justify-between border border-black/10 px-3 text-sm font-medium">Set a recurring spending cap <ArrowRight size={16} /></Link></section>
